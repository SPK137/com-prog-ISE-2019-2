public class Lab03{
	public static void main(String[] args){
		var j = new Java101();
		System.out.println(j.typeOf(20.0/2.5));
		System.out.println(20.0/2.5);
		...
		System.out.println(j.typeOf(4-6==7-9));
		System.out.println(4-6==7-9);
		System.out.println(j.typeOf((int)(5-6.5)==1-2));
		System.out.println((int)(5-6.5)==1-2);
	}
}